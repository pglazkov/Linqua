...
namespace Linqua.Service.Controllers
{
    ...
    public class EntryCountController : ApiController
    {
        ...
        public async Task<int> Get()
        {
            ...
            {
                var result = await ctx.Entries.CountAsync(x => (x.UserId == currentUser.ProviderUserInfo.ProviderPrefixedUserId || x.UserId == currentUser.AppSpecificMicrosoftUserId) && !x.Deleted);
