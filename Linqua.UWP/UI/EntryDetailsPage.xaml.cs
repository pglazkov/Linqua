...
namespace Linqua.UI
{
    ...
    public sealed partial class EntryDetailsPage : Page, IEntryDetailsView
    {
        ...
        /// </summary>
        public EntryDetailsViewModel ViewModel => (EntryDetailsViewModel)DataContext;
        ...
        {
            Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () => { Frame.Navigate(typeof(MainPage)); }).FireAndForget();
        }
    }
}