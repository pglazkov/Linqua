...
namespace Framework
{
    ...
    internal static class PropertySupport
    {
        ...
        /// <param name="compound"><c>True</c> if the full expression path should be used to build the string. ExtractPropertyName example, 
        /// call PropertySupport.ExtractPropertyName(() => MyObj.Property.NestedProperty) will result in string "MyObj.Property.NestedProperty".
        ...
        public static string ExtractPropertyName<T>(Expression<Func<T>> expression, bool compound = true)
        {
        ...
        [SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
        [SuppressMessage("Microsoft.Design", "CA1026:DefaultParametersShouldNotBeUsed")]
        public static string ExtractPropertyName(Expression<Func<object>> expression, bool compound = true)
        {
            Expression body = expression.Body;
            return GetMemberName(body, compound);
        }
