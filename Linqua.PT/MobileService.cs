...
namespace Linqua
{
	public static class MobileService
	{
		...
		public static readonly MobileServiceClient Client = new MobileServiceClient("https://linqua.azure-mobile.net/", "veBcEvMWjGNePbAKosRSIQzJGiTrfc50", new AuthFailureHandler());
	}
}